...
public class JaxbHashMapExample 
{
	public static void main(String[] args) throws JAXBException 
	{
		...
		jaxbMarshaller.marshal(employeeMap, new File("C://Users//Prashdeep//my_projects//my-first-app//src//employees.xml"));
		...
		EmployeeMap empMap = (EmployeeMap) jaxbUnmarshaller.unmarshal( new File("C://Users//Prashdeep//my_projects//my-first-app//src//employees.xml") );
